...
| 2.Atomic Swap Test Environment | Contenarised services.                      | Dockerised test environment included in [test-env/](../../test-env), so the regression suite runs from this repository alone |
