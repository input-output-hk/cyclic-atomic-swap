...
This repository provides a **Rust** reference implementation for the [Cyclic Atomic N-party Swap (CANS) protocol](docs/protocol-spec.pdf),
...
- **N-party**: The proposed implementation scales to N participants.
